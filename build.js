...
execSync('echo "Here is complete documentation for methods available on all data types.\n" >> markdown/base-methods.md')
execSync('myopts ' + thunderpath + 'base.py -c Base >> markdown/base-methods.md')

execSync('echo "# block methods\n" > markdown/block-methods.md')
execSync('echo "Here is complete documentation for methods on blocks.\n" >> markdown/block-methods.md')
